...
class _UploadScreenState extends State<UploadScreen> {
  ...
  Widget _buildHeader() {
    return const Column(
      ...
      children: [
        ...
        SizedBox(height: 4),
        Text(
          'Add your poker session results',
          style: TextStyle(
            fontSize: 14,
      ...
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color: _isDragging ? AppColors.profit : AppColors.border,
  ...
  Widget _buildRecentUploadsList() {
    final uploads = [
      _UploadData(
        fileName: 'pokerstars_session_01.png',
        date: 'Jan 7, 2026 • 2:34 PM',
        status: UploadStatus.processed,
        extractedAmount: 850,
      ),
      _UploadData(
        fileName: 'ggpoker_results.jpg',
        date: 'Jan 6, 2026 • 11:20 PM',
        status: UploadStatus.processed,
        extractedAmount: -320,
      ),
      _UploadData(
        fileName: 'session_screenshot.png',
        date: 'Jan 5, 2026 • 8:45 PM',
        status: UploadStatus.processing,
      ),
    ];

    return Column(
      children: uploads.map((upload) => _buildUploadCard(upload)).toList(),
    );
  }
