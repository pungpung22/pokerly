...
class _AnalyticsScreenState extends State<AnalyticsScreen> {
          ...
          return Expanded(
            child: GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: isSelected ? AppColors.profit : Colors.transparent,
  ...
  Widget _buildVenueBreakdown() {
    final venues = [
      _VenueData('PokerStars', 4250, 0.42),
      _VenueData('GGPoker', 2180, 0.28),
      _VenueData('Local Casino', 1810, 0.20),
    ];
