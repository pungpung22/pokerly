  ...
  return (
    <div className="app-page">
      ...
      <div className="upload-header">
        <h1 className="page-title">세션 기록하기</h1>
        <p className="page-subtitle">
          스크린샷을 업로드하면 OCR로 자동 인식됩니다. 인식된 데이터를 확인하고 저장하세요.
        </p>
      </div>
      ...
      <div className="upload-grid">
          ...
          <div className="card" style={{ padding: '24px' }}>
            <div className="upload-section-header">
              <h2 className="upload-section-title">
                <Camera style={{ width: '20px', height: '20px', color: '#6366F1' }} />
                스크린샷 업로드
              </h2>
              <div className="upload-xp-badge">
                <span className="upload-xp-badge-text">+100 XP</span>
              </div>
            </div>
            ...
            {ocrStatus !== 'idle' && (
              <div className={`upload-ocr-status ${ocrStatus}`}>
                {ocrStatus === 'processing' && <Loader2 style={{ width: '16px', height: '16px', color: '#6366F1', animation: 'spin 1s linear infinite' }} />}
                ...
                <span className={`upload-ocr-status-text ${ocrStatus}`}>
                  {ocrStatus === 'processing' && 'OCR 분석 중...'}
                  {ocrStatus === 'complete' && 'OCR 분석 완료! 오른쪽 폼에서 데이터를 확인하세요.'}
                  {ocrStatus === 'failed' && 'OCR 분석 실패. 수동으로 입력해주세요.'}
                </span>
              </div>
            )}
            ...
            <div className="upload-guide-section">
              ...
              >
                <div className="upload-guide-title">
                  <HelpCircle style={{ width: '16px', height: '16px', color: '#6366F1' }} />
                  <span className="upload-guide-title-text">스크린샷 가이드</span>
                </div>
                {showGuide ? (
                  <ChevronUp style={{ width: '16px', height: '16px', color: '#71717A' }} />
                ) : (
        ...
        <div>
          <div className="card" style={{ padding: '24px' }}>
            <div className="upload-section-header">
              <h2 className="upload-section-title">
                <Edit3 style={{ width: '20px', height: '20px', color: '#6366F1' }} />
                세션 정보
              </h2>
              <div className="upload-xp-badge">
                <span className="upload-xp-badge-text">+10 XP</span>
                <span className="upload-xp-badge-label">수동 기록</span>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="upload-form-grid-2">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder={formData.gameType === 'cash' ? '1000/2000' : '500K'}
                    required
                    className="upload-form-input"
                  />
                </div>
              ...
              {(formData.buyIn > 0 || formData.cashOut > 0) && (
                <div className={`upload-profit-preview ${profit >= 0 ? 'positive' : 'negative'}`}>
                  <span className="upload-profit-label">예상 수익</span>
